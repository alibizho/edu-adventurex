...
Every candidate question is put to a cold student (no transcript), k=3 samples. Any question the
cold student answers correctly in >= 2/3 samples is measuring priors, not teaching, and is
dropped. If fewer than 25% survive, regenerate harder.
"""
import asyncio
