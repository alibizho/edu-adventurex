...
class Store(Protocol):
    ...
    # Erase everything recorded under one session_id: transcript, analyses, run + scores, the QA
    # ledger, the topic and any analysis job. Used by "start this class over" — a lesson the
    # learner threw away must leave nothing behind for the next one to be judged against.
